...
export default function WorkshopPage() {
  ...
  const fetchServicedCars = async () => {
    ...
    try {
      ...
      // Hämta och verifiera att fordonen faktiskt har en giltig service kopplad från denna verkstad
      const checkPromises = snap.docs.map(async (d) => {
        const plate = d.id;
      ...
      checkedResults.forEach(r => { if (r) results.push(r); });
