...
import { Search, Car, Inbox, UserCircle, ShieldAlert, Settings, LogOut, Menu, Wrench, ShieldCheck, MessageSquare } from 'lucide-react';
...
export function Navbar() {
  ...
  if (pathname?.startsWith('/v/') && pathname?.endsWith('/history')) {
    return null;
  }
